...
parser.add_argument('-r','-R','--recursive', action='store_true',help="give less output")
parser.add_argument('-q', '--quiet','-recursive', action='store_true',help="remove directories and their contents recursively")
